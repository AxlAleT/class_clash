...
class _QuizCreationScreenState extends ConsumerState<QuizCreationScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final availableStrategies = ref.watch(availableGamificationStrategiesProvider);
            ...
            children: [
              ...
              Wrap(
                ...
                children: availableStrategies.map((strategy) {
                  final isSelected = _selectedGamificationStrategies.contains(strategy);
  ...
  void _saveQuiz() {
    if (_formKey.currentState!.validate()) {
      ...
      final quizData = {
        ...
        'gamification': _selectedGamificationStrategies.map((strategy) {
          return {
            'type': strategy,
            'data': {'enabled': true},
          };
